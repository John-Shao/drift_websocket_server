...
class ControlMessageHandler:
    ...
    async def handle_control_message(connection_id: str, request: dict) -> Optional[dict]:
        ...
        try:
            ...
            # 根据事件类型处理
            handler_map = {
                EventType.DEVICE_INFO: ControlMessageHandler._handle_device_info,
                EventType.START_RTMP: ControlMessageHandler._handle_start_rtmp,
                EventType.STOP_RTMP: ControlMessageHandler._handle_stop_rtmp,
                EventType.START_RTSP: ControlMessageHandler._handle_start_rtsp,
                EventType.STOP_RTSP: ControlMessageHandler._handle_stop_rtsp,
                EventType.START_RECORD: ControlMessageHandler._handle_start_record,
                EventType.STOP_RECORD: ControlMessageHandler._handle_stop_record,
                EventType.DZOOM: ControlMessageHandler._handle_dzoom,
                EventType.STREAM_RES: ControlMessageHandler._handle_stream_res,
                EventType.STREAM_BITRATE: ControlMessageHandler._handle_stream_bitrate,
                EventType.STREAM_FRAMERATE: ControlMessageHandler._handle_stream_framerate,
                EventType.LED: ControlMessageHandler._handle_led,
                EventType.EXPOSURE: ControlMessageHandler._handle_exposure,
                EventType.FILTER: ControlMessageHandler._handle_filter,
                EventType.MIC_SENSITIVITY: ControlMessageHandler._handle_mic_sensitivity,
                EventType.FOV: ControlMessageHandler._handle_fov,
                EventType.SCREEN: ControlMessageHandler._handle_screen,
                EventType.POWER_OFF: ControlMessageHandler._handle_power_off,
            }
    ...
    async def _handle_device_info(
        ...
        response = await manager.send_message(connection_id, control_msg)
    ...
    async def _handle_start_rtmp(
        ...
        result = await manager.send_message(connection_id, ctrl_msg)
    ...
    async def _handle_stop_rtmp(
        ...
        result = await manager.send_message(connection_id, control_msg)
        # 更新设备状态
        if result:
            device_status = manager.device_status.get(connection_id)
            if device_status:
    ...
    @staticmethod
    async def _handle_start_record(
        message: ControlMessage,
        connection_id: str
    ) -> dict:
        """处理开始录像"""
    ...
    @staticmethod
    async def _handle_stream_bitrate(
        message: ControlMessage,
        connection_id: str
    ) -> dict:
        """处理设置比特率"""
    ...
    @staticmethod
    async def _handle_stream_framerate(
        message: ControlMessage,
        connection_id: str
    ) -> dict:
        """处理设置帧率"""
    ...
    @staticmethod
    async def _handle_mic_sensitivity(
        message: ControlMessage,
        connection_id: str
    ) -> dict:
        """处理麦克风灵敏度设置"""
