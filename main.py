...
from drift_control_api import control_router
import uvicorn
...
# 注册路由
app.include_router(device_router, prefix=settings.api_vstr, tags=["Meeting RTS"])
app.include_router(control_router, prefix=settings.api_vstr, tags=["Callback RTS"])

# 处理根路径请求
@app.get("/")
async def root():
    return {"message": "Drift RTS Server"}
